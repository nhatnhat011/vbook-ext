function execute(key) {
    ...
    return Response.success([
		...
		{ title: "Truyện nữ", input: "https://fanqienovel.com/api/author/library/book_list/v0/?page_count=18&page_index={{page}}&gender=0&category_id=-1&creation_status=-1&word_count=-1&book_type=-1&sort=0", script: "gen.js" },
